  ...
  group('with all tools enabled', () {
      ...
      expect(
        ...
        equals([
          ...
          isA<Prompt>().having(
            (p) => p.name,
            'name',
            DashPrompts.analyzeFlutterPerformance.name,
          ),
        ]),
      );
    });
    ...
    test('can get capture performance snapshot prompt', () async {
      ...
      final prompt = await server.getPrompt(
        GetPromptRequest(name: DashPrompts.analyzeFlutterPerformance.name),
      );
      expect(
        ...
        isA<PromptMessage>()
            ...
            .having(
              (m) => m.content,
              'content',
              equals(DashPrompts.analyzeFlutterPerformancePromptContent),
            ),
      );
    });
