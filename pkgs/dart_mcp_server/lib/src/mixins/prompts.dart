...
''',
  ...
  // 5a. Ask the user for the VM service URI of their app running in profile mode.
  // 5b. Use the `record_frames` tool with the VM service URI to capture a performance snapshot of their app.
  // 5c. If there are no janky frames, jump to step 6.
  // 5d. If there are janky frames, call the analyze_frame tool with all janky frames.
  // 6. Summarize your findings. Use the results from step 2 (analyzing the code), 5b (record_frames tool, if it was used) and 5c (analyze_frame tool, if it was used).
  // ''',
  //   );
